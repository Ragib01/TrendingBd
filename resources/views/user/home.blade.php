...
<main class="ps-main">
    ...
    <div class="ps-section--features-product ps-section masonry-root pt-10 pb-50">
                ...
                <div class="masonry-wrapper" data-col-md="4" data-col-sm="2" data-col-xs="1" data-gap="30" data-radio="100%">
                    <div class="ps-masonry">
                            ...
                            <div class="grid-item__content-wrapper">
                                <div class="ps-shoe mb-30">
                                    <div class="ps-shoe__thumbnail">
                                        ...
                                        <div class="ps-badge ps-badge--sale ps-badge--2nd"><span>-35%</span></div><a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="http://skytheme.epizy.com/skytheme/images/shoe/1.jpg" alt=""><a class="ps-shoe__overlay" href="{{ url('/product') }}"></a>
                                    </div>
                                    <div class="ps-shoe__content">
                                        <div class="ps-shoe__variants">
                                            <div class="ps-shoe__variant normal"><img src="http://skytheme.epizy.com/skytheme/images/shoe/2.jpg" alt=""><img src="http://skytheme.epizy.com/skytheme/images/shoe/3.jpg" alt=""><img src="http://skytheme.epizy.com/skytheme/images/shoe/4.jpg" alt=""><img src="http://skytheme.epizy.com/skytheme/images/shoe/5.jpg" alt=""></div>
                        ...
                        <div class="grid-item nike">
                            <div class="grid-item__content-wrapper">
                                <div class="ps-shoe mb-30">
                                    <div class="ps-shoe__thumbnail"><a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="http://skytheme.epizy.com/skytheme/images/shoe/2.jpg" alt=""><a class="ps-shoe__overlay" href="product-detail.html"></a>
                                    </div>
                                    <div class="ps-shoe__content">
                                        <div class="ps-shoe__variants">
                                            <div class="ps-shoe__variant normal"><img src="http://skytheme.epizy.com/skytheme/images/shoe/2.jpg" alt=""><img src="http://skytheme.epizy.com/skytheme/images/shoe/3.jpg" alt=""><img src="http://skytheme.epizy.com/skytheme/images/shoe/4.jpg" alt=""><img src="http://skytheme.epizy.com/skytheme/images/shoe/5.jpg" alt=""></div>
                        ...
                        <div class="grid-item adidas">
                            <div class="grid-item__content-wrapper">
                                <div class="ps-shoe mb-30">
                                    <div class="ps-shoe__thumbnail"><a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="http://skytheme.epizy.com/skytheme/images/shoe/3.jpg" alt=""><a class="ps-shoe__overlay" href="product-detail.html"></a>
                                    </div>
                                    <div class="ps-shoe__content">
                                        <div class="ps-shoe__variants">
                                            <div class="ps-shoe__variant normal"><img src="http://skytheme.epizy.com/skytheme/images/shoe/2.jpg" alt=""><img src="http://skytheme.epizy.com/skytheme/images/shoe/3.jpg" alt=""><img src="http://skytheme.epizy.com/skytheme/images/shoe/4.jpg" alt=""><img src="http://skytheme.epizy.com/skytheme/images/shoe/5.jpg" alt=""></div>
                        ...
                        <div class="grid-item kids">
                            <div class="grid-item__content-wrapper">
                                <div class="ps-shoe mb-30">
                                    <div class="ps-shoe__thumbnail">
                                        <div class="ps-badge ps-badge--sale"><span>-35%</span></div><a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="http://skytheme.epizy.com/skytheme/images/shoe/4.jpg" alt=""><a class="ps-shoe__overlay" href="product-detail.html"></a>
                                    </div>
                                    <div class="ps-shoe__content">
                                        <div class="ps-shoe__variants">
                                            <div class="ps-shoe__variant normal"><img src="http://skytheme.epizy.com/skytheme/images/shoe/2.jpg" alt=""><img src="http://skytheme.epizy.com/skytheme/images/shoe/3.jpg" alt=""><img src="http://skytheme.epizy.com/skytheme/images/shoe/4.jpg" alt=""><img src="http://skytheme.epizy.com/skytheme/images/shoe/5.jpg" alt=""></div>
                        ...
                        <div class="grid-item men">
                            <div class="grid-item__content-wrapper">
                                <div class="ps-shoe mb-30">
                                    <div class="ps-shoe__thumbnail"><a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="http://skytheme.epizy.com/skytheme/images/shoe/5.jpg" alt=""><a class="ps-shoe__overlay" href="product-detail.html"></a>
                                    </div>
                                    <div class="ps-shoe__content">
                                        <div class="ps-shoe__variants">
                                            <div class="ps-shoe__variant normal"><img src="http://skytheme.epizy.com/skytheme/images/shoe/2.jpg" alt=""><img src="http://skytheme.epizy.com/skytheme/images/shoe/3.jpg" alt=""><img src="http://skytheme.epizy.com/skytheme/images/shoe/4.jpg" alt=""><img src="http://skytheme.epizy.com/skytheme/images/shoe/5.jpg" alt=""></div>
    ...
    <div class="ps-section--offer">
        <div class="ps-column"><a class="ps-offer" href=""><img src="http://skytheme.epizy.com/skytheme/images/banner/home-banner-1.png" alt=""></a></div>
        <div class="ps-column"><a class="ps-offer" href=""><img src="http://skytheme.epizy.com/skytheme/images/banner/home-banner-2.png" alt=""></a></div>
    </div>
    <div class="ps-section--sale-off ps-section pt-10 pb-30">
        <div class="ps-container">
            <div class="ps-section__header mb-0">
                <h3 class="ps-section__title"> Hot Deal Today</h3>
            </div>
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 ">
                        <div class="ps-hotspot"><a class="point first active" href="javascript:;"><i class="fa fa-plus"></i>
                                ...
                                <div class="ps-hotspot__content">
                                    <p class="heading">JUMP TO HEADER</p>
                                    <p>Dynamic Fit Collar en la zona del tobillo que une la parte inferior de la pierna y el pie sin reducir la libertad de movimiento.</p>
                                </div></a><img src="http://skytheme.epizy.com/skytheme/images/hot-deal.png" alt=""></div>
                    </div>
                </div>
            </div>
        </div>
    </div>
    <div class="ps-section ps-section--top-sales ps-owl-root pt-10 pb-0">
        <div class="ps-container">
            <div class="ps-section__header mb-0">
                <div class="row">
                    <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 ">
                        <h3 class="ps-section__title"> TRENDING NOW</h3>
                    </div>
            ...
            <div class="ps-section__content">
                <div class="ps-owl--colection owl-slider" data-owl-auto="true" data-owl-loop="true" data-owl-speed="5000" data-owl-gap="30" data-owl-nav="false" data-owl-dots="false" data-owl-item="4" data-owl-item-xs="1" data-owl-item-sm="2" data-owl-item-md="3" data-owl-item-lg="4" data-owl-duration="1000" data-owl-mousedrag="on">
                    <div class="ps-shoes--carousel">
                        <div class="ps-shoe">
                            <div class="ps-shoe__thumbnail">
                                <div class="ps-badge"><span>New</span></div><a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="http://skytheme.epizy.com/skytheme/images/shoe/1.jpg" alt=""><a class="ps-shoe__overlay" href="product-detail.html"></a>
                            </div>
                            <div class="ps-shoe__content">
                                <div class="ps-shoe__variants">
                                    <div class="ps-shoe__variant normal"><img src="http://skytheme.epizy.com/skytheme/images/shoe/2.jpg" alt=""><img src="images/shoe/3.jpg" alt=""><img src="http://skytheme.epizy.com/skytheme/images/shoe/4.jpg" alt=""><img src="http://skytheme.epizy.com/skytheme/images/shoe/5.jpg" alt=""></div>
                                    <select class="ps-rating ps-shoe__rating">
                                        <option value="1">1</option>
                                        <option value="1">2</option>
                                        <option value="1">3</option>
    ...
    <div class="ps-section--offer pt-10 pb-10">
    ...
    <div class="ps-section ps-section--top-sales ps-owl-root pt-10 pb-10">
        <div class="ps-container">
            <div class="ps-section__header mb-0">
                <div class="row">
                    <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 ">
                        <h3 class="ps-section__title"> SHOP BY BRANDS</h3>
                    </div>
                    <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 ">
                        <div class="ps-owl-actions"><a class="ps-prev" href="#"><i class="ps-icon-arrow-right"></i>Prev</a><a class="ps-next" href="#">Next<i class="ps-icon-arrow-left"></i></a></div>
                    </div>
            ...
            <div class="ps-section__content">
                <div class="ps-owl--colection owl-slider" data-owl-auto="true" data-owl-loop="true" data-owl-speed="3000" data-owl-gap="30" data-owl-nav="false" data-owl-dots="false" data-owl-item="4" data-owl-item-xs="1" data-owl-item-sm="2" data-owl-item-md="3" data-owl-item-lg="4" data-owl-duration="1000" data-owl-mousedrag="on">

                    <div class="ps-brands--carousel">
                        <div class="ps-brand">
                            <div class="ps-brand__thumbnail"><img src="{{ url('user/images/power_80743e54-9758-463f-ad3f-08ed9552f8fb.png') }}" alt=""><a class="ps-brand__overlay" href="product-detail.html"></a>
                            </div>
                        </div>
                    </div>
    ...
    <div class="ps-blog-grid pt-0 pb-10">
    <div class="ps-container">
        <div class="ps-section__header mb-0">
            <h3 class="ps-section__title"> PICK YOUR FAVOURITES</h3>
        </div>
        <div class="row">
            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 ">
                <div class="ps-post mb-30">
                    <div class="ps-post__thumbnail"><a class="ps-post__overlay" href="blog-detail.html"></a><img src="{{ url('user/images/blog/1.jpg') }}" alt=""></div>
                    <div class="ps-post__content"><a class="ps-post__title" href="blog-detail.html">An Inside Look at the Breaking2 Kit</a>
                        <p>Leverage agile frameworks to provide a robust synopsis for high level overviews. Iterative approaches to corporate strategy foster collaborative thinking to further…</p><a class="ps-morelink" href="blog-detail.html">SHOP NOW<i class="fa fa-long-arrow-right"></i></a>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 ">
            ...
            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 ">
                <div class="ps-post mb-30">
                    <div class="ps-post__thumbnail"><a class="ps-post__overlay" href="blog-detail.html"></a><img src="{{ url('user/images/blog/2.jpg') }}" alt=""></div>
